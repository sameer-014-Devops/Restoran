...
#Variable
  ...
  KubeW01_Pub_IP =
  KubeW02_Pub_IP =
  Prod_Workspace = /home/${User_Name}/workspace/Restoran_Production_Pipeline
  Build01_Pvt_IP =
...
pipeline {
    ...
    stages {
        ...
        stage('SCM_Checkout') {
            ...
            steps {
                ...
                git 'https://github.com/sameer-014-Devops/Restoran.git'
            }
            post {
                success {
                    script {
    ...
    post {
        success {
            build job: 'Restoran_Production_Pipeline', parameters: [string(name: 'new_ver', value: env.new_ver)]
